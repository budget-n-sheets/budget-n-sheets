...
function copyMonths_ (spreadsheet) {
  ...
  while (++mm < 12) {
    ...
    new ToolInsertRowsMonth(mm).insertRowsTo(last, true);
...
function copyCards_ (spreadsheet) {
  ...
  new ToolInsertRowsCards().insertRowsTo(destination.getMaxRows(), true);
...
function copyTags_ (spreadsheet) {
  ...
  new ToolInsertRowsTags().insertRowsTo(destination.getMaxRows(), true);
